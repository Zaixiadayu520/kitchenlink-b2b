...
export function WhatsAppFloat({ locale }: { locale: Locale }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(37,211,102,0.45)] transition hover:scale-105 hover:bg-[#1ebe57] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366] max-md:bottom-[calc(1.25rem+env(safe-area-inset-bottom))]"
